...
int main()
{
    ...
    read_system_flag = read_system_predict(&frame_info, &Nframes_tot);
    ...
    {
        printf_d("atom type %d coord %.3lf %.3lf %.3lf\n", frame_info[DEBUG_FRAME].neighbour_list[DEBUG_ATOM].type[i], frame_info[DEBUG_FRAME].neighbour_list[DEBUG_ATOM].coord_neighbours[i * 3 + 0], frame_info[DEBUG_FRAME].neighbour_list[DEBUG_ATOM].coord_neighbours[i * 3 + 1], frame_info[DEBUG_FRAME].neighbour_list[DEBUG_ATOM].coord_neighbours[i * 3 + 2]);
    }
    ...
    save_to_file_flag = save_to_file_predict(frame_info, parameters_info, (void *)sym_coord_DeePMD);
