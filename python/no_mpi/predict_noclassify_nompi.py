...
parameters_from_file_adapt_bin.N_types_all_frame = parameters_from_bin.N_types_all_frame
parameters_from_file_adapt_bin.filter_neuron = parameters_from_bin.filter_neuron
parameters_from_file_adapt_bin.axis_neuron = parameters_from_bin.axis_neuron
parameters_from_file_adapt_bin.fitting_neuron = parameters_from_bin.fitting_neuron
parameters_from_file_adapt_bin.SEL_A_max = parameters_from_bin.SEL_A_max
parameters = parameters_from_file_adapt_bin
...
if (parameters_from_file.SEL_A_max < parameters_from_bin.SEL_A_max):
    ...
    print("-----------------------------------------------")
    print("|*******************WARNING*******************|")
    print("| SEL_A_max IS TOO SMALL FOR THE TESTING SET! |")
